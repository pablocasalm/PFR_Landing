  ...
  return (
    ...
    >
      <div className="glass-panel mx-auto max-w-4xl rounded-3xl p-6 sm:p-10">
        <p className="font-mono text-xs uppercase tracking-[0.26em] text-accent-cyan">Waitlist privada</p>
        ...
        <p className="mt-5 text-base text-muted sm:text-lg">
          Únete hoy para recibir acceso anticipado y análisis de muestra antes del lanzamiento.
        </p>
        <div className="mt-8">
